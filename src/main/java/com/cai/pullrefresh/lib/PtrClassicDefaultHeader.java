...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private String getLastUpdateTime() {
        ...
        sb.append(getContext().getResources().getString(R.string.cube_ptr_last_update));

        if (seconds < 60) {
            sb.append(seconds + getContext().getResources().getString(R.string.cube_ptr_seconds_ago));
        } else {
            ...
            if (minutes > 60) {
                ...
                if (hours > 24) {
                    ...
                    sb.append(hours + getContext().getResources().getString(R.string.cube_ptr_hours_ago));
                }

            } else {
                sb.append(minutes + getContext().getResources().getString(R.string.cube_ptr_minutes_ago));
            }
        }
        return sb.toString();
    }
