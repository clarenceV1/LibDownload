...
public class SwipeMenuLayout extends FrameLayout {
    ...
    public void setContentViewPressed(boolean pressed) {
        mContentView.setPressed(pressed);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        PtrRecyclerView mPtrRecyclerView = null;
        if (parentView instanceof PtrRecyclerView) {
            mPtrRecyclerView = (PtrRecyclerView) parentView;
        }
        //
        if (mPtrRecyclerView != null) {
            return false;
        } else {
    ...
    public void setPtrOnClickListener( OnClickListener l){
        listener=l;
    }


    public void setPtrOnLongClickListener(OnLongClickListener l) {
        longClickListener=l;
    }
